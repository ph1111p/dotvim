...
" Groups
"execute "hi Cursor guifg="      . s:Colors[12]  . " guibg=" . s:Colors[4]
execute "hi Cursor guifg="	. s:Colors[1]   . " guibg=" . s:Colors[9] 
"execute "hi CursorIM guifg="    . s:Colors[12]  . " guibg=" . s:Colors[4]
execute "hi CursorIM guifg="      . s:Colors[13] . " guibg=" . s:Colors[7]
...
execute "hi Folded guifg="  . s:Colors[1]  . " guibg=" . s:Colors[13] . " gui=underline" . " term=bold,underline" . " cterm=bold,underline"
"execute "hi IncSearch guifg="   . s:Colors[1]  . " guibg=" . s:Colors[12] . " gui=none"
execute "hi IncSearch	guifg=" . s:Colors[12] . " guibg=" . s:Colors[11]
...
execute "hi Search	guifg="     . s:Colors[12] . " guibg=" . s:Colors[11]
...
execute "hi TabLine guifg="     . s:Colors[8]  . " guibg=" . s:Colors[12] . " gui=underline"
execute "hi TabLineFill guifg=" . s:Colors[12] . " guibg=" . s:Colors[13] . " gui=underline"
execute "hi TabLineSel guifg="  . s:Colors[1]  . " guibg=" . s:Colors[13] . " gui=underline" . " term=bold,underline" . " cterm=bold,underline"
...
execute "hi Visual	guifg="     . s:Colors[12] . " guibg=" . s:Colors[11] . " gui=none"
