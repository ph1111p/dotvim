...
hi StatusLineNC         cterm=none ctermbg=none     ctermfg=7       gui=none        guibg=#5D5D5D   guifg=#FBFBFB
...
hi Folded               cterm=none ctermbg=none     ctermfg=7       gui=none        guibg=#3B3B3B   guifg=#90AB41
hi FoldColumn           cterm=none ctermbg=none     ctermfg=7       gui=none        guibg=#3B3B3B   guifg=#90AB41
...
hi Visual               cterm=none ctermbg=4        ctermfg=0       gui=none        guibg=#F7F7F7   guifg=#8F8F8F
...
hi TabLine              cterm=underline ctermfg=15       ctermbg=8       gui=underline   guibg=#8F8F8F   guifg=#F7F7F7
hi TabLineFill          cterm=underline ctermfg=15       ctermbg=8       gui=underline   guibg=#8F8F8F   guifg=#F7F7F7
hi TabLineSel           cterm=none ctermbg=none     ctermfg=3       gui=none        guibg=#282828   guifg=#F7F7F7
hi VertSplit            cterm=none ctermbg=8        ctermfg=15      gui=none        guibg=#8F8F8F   guifg=#F7F7F7

hi AirlineBlue          cterm=none ctermbg=4        ctermfg=0
hi AirlineIBlue         cterm=none ctermbg=12       ctermfg=0
hi AirlineWhite         cterm=none ctermbg=7        ctermfg=0
hi AirlineIWhite        cterm=none ctermbg=15       ctermfg=0
hi AirlineBlack         cterm=none ctermbg=0        ctermfg=7
hi AirlineIBlack        cterm=none ctermbg=8        ctermfg=15
hi AirlineYellow        cterm=none ctermbg=3        ctermfg=0
hi AirlineIYellow       cterm=none ctermbg=11       ctermfg=0
hi AirlineRed           cterm=none ctermbg=1        ctermfg=0
hi AirlineIRed          cterm=none ctermbg=9        ctermfg=0

" ----------------------------------------------------------------------------
" Syntax Highlighting
" ----------------------------------------------------------------------------
hi Keyword              cterm=none ctermbg=none ctermfg=10          gui=none        guifg=#D1FA71
hi Comment              cterm=none ctermbg=none ctermfg=7           gui=none        guifg=#8F8F8F
...
hi String               cterm=none ctermbg=none ctermfg=11          gui=none        guifg=#F6DC69
hi Number               cterm=none ctermbg=none ctermfg=11          gui=none        guifg=#F6DC69
